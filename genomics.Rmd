...
subFoldersFull <- "/ifs/data/Hiseq/Runs/TestRuns/Tombcl2/160622_D00467_0182_AC9BM5ANXX/"
Run_folders_WithRTA <- "/ifs/data/Hiseq/Runs/TestRuns/Tombcl2/160622_D00467_0182_AC9BM5ANXX/"
...
for(i in 1:length(shellBCLs)){
dir.create(gsub("\\.sh","/",shellBCLs[i]),showWarnings = F)
